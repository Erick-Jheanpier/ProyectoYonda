        ...
        <div class="DataLabor">
          <div class="row mb-2">
            ...
            <div class="col-md-4">
              ...
              <p><b>FECHA DE FIN:</b> <?= $trabajador['fechafin'] ?? '---' ?></p>
              <p><b>TOLERANCIA DIARIA (min):</b> <?= $trabajador['toleranciadiaria'] ?? '---' ?></p>
              <p><b>TOLERANCIA MENSUAL (min):</b> <?= $trabajador['toleranciamensual'] ?? '---' ?></p>
            </div>
          </div>
        </div>
      </div>
